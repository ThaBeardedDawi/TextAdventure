...
//Inv system
    if (inputArray[0] == "pak" && currentLocation == 6){
          if ((inputArray[1]) != -1) {
            switch (inputArray[1]) {
              case "sleutel":
                console.log("suc6");
                sleutel = true;
                console.log(sleutel);
                myInventory.innerHTML = "Je hebt een sleutel in je inventory";
                directions[5].push('noord');
                break;
        }
      }
        else {
...
console.log('met mede dank aan Kevin de westfries <3');
console.log('I deserve nicotine');
